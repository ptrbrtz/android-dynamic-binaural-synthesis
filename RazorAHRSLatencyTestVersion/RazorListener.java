...
public interface RazorListener {
	 ...
	 * @param pitch
	 * @param roll
	 * @param receiveTimestamp Time when the data was read from Bluetooth input stream. Use System.nanoTime() to compare to current time.
	 */
	void onAnglesUpdate(float yaw, float pitch, float roll, long timestamp);
